...
-- create system function json.nest table( id integer, k string, v string)
-- returns json external name json.nest;

create system aggregate json.tojsonarray( x string ) returns string external name aggr.jsonaggr;
GRANT EXECUTE ON AGGREGATE json.tojsonarray( string ) TO PUBLIC;
create system aggregate json.tojsonarray( x double ) returns string external name aggr.jsonaggr;
