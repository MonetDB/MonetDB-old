...
typedef enum tokens {
	...
	SQL_XMLVALIDATE,
	SQL_XMLNAMESPACES,
	SQL_START_CONTINUOUS_PROCEDURE,
	SQL_RESTART_CONTINUOUS_PROCEDURE,
	SQL_INTERRUPT_CONTINUOUS_PROCEDURE,
	SQL_CONTINUE_CONTINUOUS_PROCEDURE,
	SQL_HALT_CONTINUOUS_PROCEDURE
} tokens;
