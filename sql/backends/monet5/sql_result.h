...
sql_extern int mvc_result_table(mvc *m, oid query_id, int nr_cols, sql_query_t type, BAT *order);
...
sql_extern int convert2str(mvc *m, sql_class eclass, int d, int sc, int has_tz, ptr p, int mtype, char **buf, int len);
