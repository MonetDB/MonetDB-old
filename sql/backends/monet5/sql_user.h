...
sql_extern void monet5_user_init(backend_functions *be_funcs);
sql_extern str monet5_user_set_def_schema(mvc *m, oid user /* mal user id */);
sql_extern str monet5_user_get_def_schema(mvc *m, int user /* sql user id */);
