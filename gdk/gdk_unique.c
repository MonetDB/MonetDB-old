...
BATunique(BAT *b, BAT *s)
{
	...
	if (b->tkey || BATcount(b) <= 1 || BATtdense(b)) {
		...
		if (s) {
			...
			ALGODEBUG MT_fprintf(stderr, "#BATunique(b=" ALGOBATFMT
		...
		ALGODEBUG MT_fprintf(stderr, "#BATunique(b=" ALGOBATFMT ",s=NULL):"
	...
	if (start == end) {
		...
		ALGODEBUG MT_fprintf(stderr, "#BATunique(b=" ALGOBATFMT ",s="
