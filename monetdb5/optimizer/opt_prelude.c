...
str weldAggrSumRef;
str weldAlgebraDifferenceRef;
str weldAlgebraIntersectRef;
...
str weldBatcalcDivRef;
str weldBatcalcModRef;
str weldBatcalcEqRef;
str weldBatcalcLtRef;
str weldBatcalcLeRef;
...
void optimizerInit(void)
{
	...
	weldAlgebraDifferenceRef = putName("algebradifference");
	weldAlgebraIntersectRef = putName("algebraintersect");
	...
	weldBatcalcDivRef = putName("batcalcdiv");
	weldBatcalcModRef = putName("batcalcmod");
	weldBatcalcEqRef = putName("batcalceq");
	weldBatcalcLtRef = putName("batcalclt");
	weldBatcalcLeRef = putName("batcalcle");
